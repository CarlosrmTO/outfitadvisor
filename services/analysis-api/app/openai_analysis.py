...
def analyze_with_openai(
    *,
    ...
    system_prompt = (
        ...
        "  colores de la ropa que lleva en la foto. "
        "- 'recommendations': lista de frases cortas y accionables que combinen: "
        "   • tipos de prendas que equilibran su silueta; "
        "   • cortes y materiales que potencian sus proporciones; "
        "   • colores recomendados y colores a evitar; "
        "   • ideas de conjuntos completos (parte de arriba, parte de abajo, calzado y "
        "     accesorios) pensados como PRODUCTOS o categorías de producto que podría "
        "     comprar. Cada frase debe incluir una justificación muy breve basada en "
        "     los rasgos detectados. "
        "\n\n"
